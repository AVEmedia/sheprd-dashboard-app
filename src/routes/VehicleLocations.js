...
class VehicleLocationsContainer extends React.Component {
  render() {
    return (
      <PanelContainer>
        <Panel>
...
export default class VehicleLocations extends React.Component {
  constructor(props) {
    super(props);
    this.geocode = null;
      ...
      <div>
        <Row>
          <Col sm={6} collapseRight>
            <VehicleLocationsContainer id='basic-map' name='Basic Map' />
            <VehicleLocationsContainer id='markers' name='Map Markers' />
            <VehicleLocationsContainer id='polyline' name='Polylines' />
            <VehicleLocationsContainer id='polygon' name='Polygon' />
          </Col>
          <Col sm={6}>
            <VehicleLocationsContainer id='map-events' name='Map Events' />
            <VehicleLocationsContainer id='geocode' name='Geocoding'>
            ...
            </VehicleLocationsContainer>
            <VehicleLocationsContainer id='overlays' name='Overlays' />
            <VehicleLocationsContainer id='geojson' name='GeoJSON Polygon' />
          </Col>
        </Row>
        <Row>
          <Col xs={12}>
